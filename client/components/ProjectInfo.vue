<template>
  ...
  >
    ...
    <div id="info">
      ...
      <p>This app is the case-study project for the course <strong>Enterprise Vue</strong>!</p><a
        href="https://vuejsdevelopers.com/courses/enterprise-vue"
      >Learn more</a>
    </div>
  </div>
</template>
